<x-layout>
    ...
    <form action="{{ route('report.store') }}" method="post" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex items-center space-x-3">
            <input type="checkbox" id="hs-default-checkbox"
                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
